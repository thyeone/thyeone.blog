...
2. 위의 플러그인은 Icon 컴포넌트에 아이콘을 한 곳에 모두 import하고 `ts-pattern` 으로 return하는 구조입니다. 현재 import하는 아이콘이 540개인데, **트리쉐이킹**이 되지 않아 Icon 컴포넌트를 import 했을 때 타입 추론이 매우 느려지는 불편함이 있었습니다.
...
[소스코드](https://github.com/thyeone/figma-icon-plugin)
...
<Callout type='info'>
  ...
  위해서는 스크립트를 개발해야 했습니다.
</Callout>

[@svgr/core](https://react-svgr.com/docs/node-api/) 모듈을 사용하여 스크립트를 간편하게 작성할 수 있었습니다. [소스 코드](https://github.com/thyeone/svgr-transform)
