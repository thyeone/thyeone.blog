  ...
  return (
    ...
    >
      <div className="flex flex-col flex-1">
        <span className="text-2xl font-bold group-hover:opacity-70 transition duration-300 ease-in-out">
          {title}
        </span>
        <Text
          fontSize="sm"
          className="mt-8 group-hover:opacity-70 transition duration-300 ease-in-out"
        >
          {description}
        </Text>
        <span className="mt-16 text-xs text-gray-500">
